...
locations = {
    ...
    'taiping_fu': {'name': '太平府', 'x': CENTER_X + 45, 'y': CENTER_Y + 40, 'terrain': 'city', 'min_level': 7},
    'yingtian_fu': {'name': '应天府', 'x': CENTER_X + 50, 'y': CENTER_Y + 55, 'terrain': 'city', 'min_level': 8},
    'huizhou': {'name': '徽州', 'x': CENTER_X + 65, 'y': CENTER_Y + 30, 'terrain': 'city', 'min_level': 9},
    'zhedong': {'name': '浙东', 'x': CENTER_X + 60, 'y': CENTER_Y - 10, 'terrain': 'coastal', 'min_level': 10},
    'jinhua': {'name': '金华', 'x': CENTER_X + 60, 'y': CENTER_Y - 25, 'terrain': 'plains', 'min_level': 11},
    'poyang_hu': {'name': '鄱阳湖', 'x': CENTER_X + 10, 'y': CENTER_Y + 55, 'terrain': 'water', 'min_level': 12},
    'suzhou': {'name': '苏州', 'x': CENTER_X + 65, 'y': CENTER_Y + 15, 'terrain': 'city', 'min_level': 13},
    'yuan_dadu': {'name': '元大都', 'x': CENTER_X - 55, 'y': CENTER_Y - 5, 'terrain': 'city', 'min_level': 14},
    'sichuan': {'name': '四川', 'x': CENTER_X - 45, 'y': CENTER_Y + 40, 'terrain': 'mountain', 'min_level': 15},
    'yunnan': {'name': '云南', 'x': CENTER_X - 20, 'y': CENTER_Y + 60, 'terrain': 'mountain', 'min_level': 16},
    'beijing': {'name': '北京', 'x': CENTER_X, 'y': CENTER_Y - 55, 'terrain': 'city', 'min_level': 17},
    'changan': {'name': '长安', 'x': CENTER_X - 50, 'y': CENTER_Y - 25, 'terrain': 'city', 'min_level': 18},
    'xiangyang': {'name': '襄阳', 'x': CENTER_X - 25, 'y': CENTER_Y - 5, 'terrain': 'city', 'min_level': 4},
    'nanchang': {'name': '南昌', 'x': CENTER_X + 25, 'y': CENTER_Y + 45, 'terrain': 'city', 'min_level': 7},
    'guangzhou': {'name': '广州', 'x': CENTER_X + 35, 'y': CENTER_Y + 65, 'terrain': 'city', 'min_level': 19},
    'hangzhou': {'name': '杭州', 'x': CENTER_X + 70, 'y': CENTER_Y - 15, 'terrain': 'city', 'min_level': 12},
}
...
def add_branch_roads(data):
    branches = [
        (CENTER_X, CENTER_Y, CENTER_X + 30, CENTER_Y),
        (CENTER_X, CENTER_Y, CENTER_X - 30, CENTER_Y),
        (CENTER_X, CENTER_Y, CENTER_X, CENTER_Y + 30),
        (CENTER_X, CENTER_Y, CENTER_X, CENTER_Y - 30),
        (CENTER_X + 30, CENTER_Y, CENTER_X + 30, CENTER_Y + 25),
        (CENTER_X + 30, CENTER_Y, CENTER_X + 55, CENTER_Y),
        (CENTER_X + 55, CENTER_Y, CENTER_X + 70, CENTER_Y),
        (CENTER_X - 30, CENTER_Y, CENTER_X - 30, CENTER_Y + 30),
        (CENTER_X - 30, CENTER_Y, CENTER_X - 55, CENTER_Y),
        (CENTER_X - 55, CENTER_Y, CENTER_X - 55, CENTER_Y - 25),
        (CENTER_X, CENTER_Y + 30, CENTER_X, CENTER_Y + 55),
        (CENTER_X, CENTER_Y + 30, CENTER_X + 25, CENTER_Y + 30),
        (CENTER_X, CENTER_Y + 55, CENTER_X + 50, CENTER_Y + 55),
        (CENTER_X, CENTER_Y + 55, CENTER_X - 20, CENTER_Y + 55),
        (CENTER_X, CENTER_Y - 30, CENTER_X, CENTER_Y - 55),
        (CENTER_X, CENTER_Y - 30, CENTER_X + 60, CENTER_Y - 30),
        (CENTER_X, CENTER_Y - 30, CENTER_X - 50, CENTER_Y - 30),
        (CENTER_X + 30, CENTER_Y + 25, CENTER_X + 45, CENTER_Y + 40),
        (CENTER_X + 55, CENTER_Y, CENTER_X + 55, CENTER_Y - 25),
        (CENTER_X + 55, CENTER_Y, CENTER_X + 55, CENTER_Y + 20),
        (CENTER_X - 30, CENTER_Y + 30, CENTER_X - 45, CENTER_Y + 40),
        (CENTER_X - 55, CENTER_Y, CENTER_X - 55, CENTER_Y - 20),
        (CENTER_X + 25, CENTER_Y + 30, CENTER_X + 50, CENTER_Y + 55),
        (CENTER_X - 20, CENTER_Y + 55, CENTER_X - 45, CENTER_Y + 40),
        (CENTER_X + 65, CENTER_Y, CENTER_X + 70, CENTER_Y - 15),
        (CENTER_X + 60, CENTER_Y - 30, CENTER_X + 60, CENTER_Y - 25),
        (CENTER_X - 50, CENTER_Y - 30, CENTER_X - 50, CENTER_Y - 25),
        (CENTER_X - 25, CENTER_Y, CENTER_X - 25, CENTER_Y - 5),
        (CENTER_X + 55, CENTER_Y + 20, CENTER_X + 65, CENTER_Y + 15),
        (CENTER_X + 65, CENTER_Y + 30, CENTER_X + 65, CENTER_Y + 15),
        (CENTER_X + 50, CENTER_Y + 55, CENTER_X + 35, CENTER_Y + 65),
        (CENTER_X - 20, CENTER_Y + 55, CENTER_X + 35, CENTER_Y + 65),
    ]
